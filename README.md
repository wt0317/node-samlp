...
| signatureSettings     | allows adding prefix to signature tags, attrs to signature root node, and specifying location of signature node (see https://github.com/yaronn/xml-crypto#signedxml > computeSignature > options) | null |
